...
<div class="container">
    ...
    <div class="gC">
        <div class="gX gMX product-builder" id="productBuilder">
            <div class="c s12 m6 l6 prodImgs">
                <div class="images">
                    <img src="https://cdn.shopify.com/s/files/1/0324/8091/9684/files/covorase_mocheta_negre_margine_neagra_1_450x450_crop_center.png?v=1716176820" alt="Image" id="firstImage" width="351" height="351">
                    <img src="https://cdn.shopify.com/s/files/1/0324/8091/9684/files/covorase_mocheta_negre_margine_neagra_2_450x450_crop_center.jpg?v=1716176820" alt="Image" id="secondImage" width="351" height="351">
                    <img src="https://cdn.shopify.com/s/files/1/0324/8091/9684/files/covorase_mocheta_negre_margine_neagra_3_450x450_crop_center.png?v=1716176820" alt="Image" id="thirdImage" width="351" height="351">
                    <img src="https://cdn.shopify.com/s/files/1/0324/8091/9684/files/covorase_mocheta_negre_margine_neagra_4_450x450_crop_center.jpg?v=1716176819" alt="Image" id="fourthImage" width="351" height="351">
                    <img src="https://cdn.shopify.com/s/files/1/0324/8091/9684/files/covorase_mocheta_negre_margine_neagra_5_450x450_crop_center.png?v=1716176820" alt="Image" id="fifthImage" width="351" height="351">
                    <img src="https://cdn.shopify.com/s/files/1/0324/8091/9684/files/covorase_mocheta_negre_margine_neagra_6_450x450_crop_center.jpg?v=1716176820" alt="Image" id="sixthImage" width="351" height="351">
                    <img src="https://cdn.shopify.com/s/files/1/0324/8091/9684/files/covorase_mocheta_negre_margine_neagra_7_450x450_crop_center.jpg?v=1716176820" alt="Image" id="seventhImage" width="351" height="351">
                </div>
            </div>
            <div class="c s12 m6 l6 prodContent" id="productBuilderFields">
                ...
                <div class="gX gMX hBuildBox">
                    <div class="c s12 m12 l12">
                        ...
                        <div class="options">
                            ...
                            <div class="option" id="threadType" style="display:none !important;">
                            ...
                            <div class="option" id="reinforcement" style="display:none">
                                <p class="option-title">Intaritura calcai sofer: <span class="value">nu</span></p>
                                <div class="option-values">
                                    <label class="option-value box">
                                        <input type="radio" name="reinforcement" value="no" checked>
                                        <span class="box-text">Nu</span>
                                    </label>
                                    <label class="option-value box">
                                        <input type="radio" name="reinforcement" value="yes">
                                        <span class="box-text">Da</span>
                                    </label>
                                </div>
                            </div>
                            <div class="option" id="configuration" style="display:none">
                                <p class="option-title">Configuratie <span class="value">Portbagaj</span></p>
                                <div class="option-values four-columns">
                                    <label class="option-value image">
                                        <input type="radio" name="configuration" value="full" checked>
                                        <img src="assets/images/configuration-full.jpg" alt="Front">
                                    </label>
                                    <label class="option-value image">
                                        <input type="radio" name="configuration" value="full-with-trunk">
                                        <img src="assets/images/configuration-full-with-trunk.jpg" alt="Front">
                                    </label>
                                    <label class="option-value image">
                                        <input type="radio" name="configuration" value="front">
                                        <img src="assets/images/configuration-front.jpg" alt="Front">
                                    </label>
                                    <label class="option-value image">
                                        <input type="radio" name="configuration" value="trunk">
                                        <img src="assets/images/configuration-trunk.jpg" alt="Front">
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="gX gMX ">
                            ...
                            <div class="c s6 m6 l6">
                                <p class="pBuilderShipping">Livrare maine<br><span class="product-price"
                                                                                   id="price"><span>198</span> lei</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="c s12 m12 l12">
                        ...
                        <div id="embroideryBuilder" style="display:none;">
                            <div id="controls">
                                ...
                                <div id="editItemElements">
                                    <p class="title">Adauga broderie pe:</p>
                                    <div class="itemTypes">
                                        <div class="itemType">
                                            <button type="button" id="embroideryEditAllModalBtn">Toate covorasele</button>
                                        </div>
                                        <div class="itemType">
                                            <button type="button" id="embroideryEditCustomModalBtn">Individual</button>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="tingle-modal-box__content">
                                            ...
                                            <div class="types-and-canvas">
                                                ...
                                                <div class="embroideryImages">
                                                    <div class="embroideryImage" id="embroideryModalImageItem1"></div>
                                                    <div class="embroideryImage" id="embroideryModalImageItem2"></div>
                                                    <div class="embroideryImage" id="embroideryModalImageItem3"></div>
                                                    <div class="embroideryImage" id="embroideryModalImageItem4"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="glide__slides">
                                        <li class="glide__slide">
                                            <div class="embroideryImageWrapper">
                                                <div class="embroideryImage" id="embroideryImageItem1"></div>
                                                <button class="btn" onclick="PTCProductBuilder.embroideryBuilder.showEmbroideryEditModal('custom', 'item-1')">Editeaza covoras sofer</button>
                                            </div>
                                        </li>
                                        <li class="glide__slide">
                                            <div class="embroideryImageWrapper">
                                                <div class="embroideryImage" id="embroideryImageItem2"></div>
                                                <button class="btn" onclick="PTCProductBuilder.embroideryBuilder.showEmbroideryEditModal('custom', 'item-2')">Editeaza covoras pasager</button>
                                            </div>
                                        </li>
                                        <li class="glide__slide">
                                            <div class="embroideryImageWrapper">
                                                <div class="embroideryImage" id="embroideryImageItem3"></div>
                                                <button class="btn" onclick="PTCProductBuilder.embroideryBuilder.showEmbroideryEditModal('custom', 'item-3')">Editeaza covoras stanga spate</button>
                                            </div>
                                        </li>
                                        <li class="glide__slide">
                                            <div class="embroideryImageWrapper">
                                                <div class="embroideryImage" id="embroideryImageItem4"></div>
                                                <button class="btn" onclick="PTCProductBuilder.embroideryBuilder.showEmbroideryEditModal('custom', 'item-4')">Editeaza covoras dreapta spate</button>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                ...
                <button type="submit" class="add-to-cart" id="submitProductBuilder">Adauga in cos</button><br><br>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const config = {
                "apiURL": "https://api.ptc-auto.ro/apis/mocheta_1.php",
